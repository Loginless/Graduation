...
public class MenuTestData {
    ...
    public static final Menu MENU1 = new Menu(MENU1_ID, RESTAURANT1, LocalDate.of(2018, 12, 01), DISH1, 150);
    public static final Menu MENU2 = new Menu(MENU1_ID + 1, RESTAURANT1, LocalDate.of(2018, 12, 01), DISH2, 80);
    public static final Menu MENU3 = new Menu(MENU1_ID + 2, RESTAURANT1, LocalDate.of(2018, 12, 01), DISH3, 90);
    public static final Menu MENU4 = new Menu(MENU1_ID + 3, RESTAURANT1, LocalDate.of(2018, 12, 02), DISH4, 150);
    public static final Menu MENU5 = new Menu(MENU1_ID + 4, RESTAURANT1, LocalDate.of(2018, 12, 02), DISH5, 80);
    public static final Menu MENU6 = new Menu(MENU1_ID + 5, RESTAURANT1, LocalDate.of(2018, 12, 02), DISH6, 90);
    public static final Menu MENU7 = new Menu(MENU1_ID + 6, RESTAURANT2, LocalDate.of(2018, 12, 01), DISH7, 125);
    public static final Menu MENU8 = new Menu(MENU1_ID + 7, RESTAURANT2, LocalDate.of(2018, 12, 01), DISH8, 135);
    public static final Menu MENU9 = new Menu(MENU1_ID + 8, RESTAURANT2, LocalDate.of(2018, 12, 01), DISH9, 80);
    public static final Menu MENU10 = new Menu(MENU1_ID + 9, RESTAURANT2, LocalDate.of(2018, 12, 02), DISH7, 125);
    public static final Menu MENU11 = new Menu(MENU1_ID + 10, RESTAURANT2, LocalDate.of(2018, 12, 02), DISH8, 135);
    public static final Menu MENU12 = new Menu(MENU1_ID + 11, RESTAURANT2, LocalDate.of(2018, 12, 02), DISH9, 80);
    public static final Menu MENU13 = new Menu(MENU1_ID + 12, RESTAURANT3, LocalDate.of(2018, 12, 01), DISH5, 122);
    public static final Menu MENU14 = new Menu(MENU1_ID + 13, RESTAURANT3, LocalDate.of(2018, 12, 01), DISH10, 50);
    public static final Menu MENU15 = new Menu(MENU1_ID + 14, RESTAURANT3, LocalDate.of(2018, 12, 02), DISH5, 122);
