...
public class VotesTestData {
    ...
    public static final Vote VOTE1 = new Vote(VOTE1_ID, USER1, RESTAURANT1, LocalDate.of(2018, 12, 01));
    public static final Vote VOTE2 = new Vote(VOTE1_ID + 1, USER2, RESTAURANT3, LocalDate.of(2018, 12, 01));
    public static final Vote VOTE3 = new Vote(VOTE1_ID + 2, USER1, RESTAURANT2, LocalDate.of(2018, 12, 02));
    public static final Vote VOTE4 = new Vote(VOTE1_ID + 3, USER2, RESTAURANT2, LocalDate.of(2018, 12, 02));
    public static final Vote VOTE5 = new Vote(VOTE1_ID + 4, ADMIN, RESTAURANT1, LocalDate.of(2018, 12, 02));
    public static final Vote VOTE6 = new Vote(VOTE1_ID + 5, USER1, RESTAURANT2, LocalDate.of(2018, 12, 03));
    public static final Vote VOTE7 = new Vote(VOTE1_ID + 6, USER2, RESTAURANT2, LocalDate.of(2018, 12, 03));
